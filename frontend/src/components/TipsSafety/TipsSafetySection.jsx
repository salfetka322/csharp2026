import TipsSafetyContent from './TipsSafetyContent';

const TipsSafetySection = () => {
  return (
    <section className='relative min-h-screen w-full py-16 px-6 bg-gradient-to-br from-[#050505] via-[#0a0a0a] via-[#0f0f0f] to-[#050505] flex justify-center'>
...
export default TipsSafetySection;
