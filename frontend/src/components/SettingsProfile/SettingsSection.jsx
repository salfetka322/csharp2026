...
const SettingsSection = () => {
  return (
    <section className='relative flex items-center justify-center min-h-screen py-6 md:py-10 px-4 md:px-6 bg-gradient-to-br from-[#050505] via-[#0a0a0a] via-[#0f0f0f] to-[#050505]'>
