...
const ContactSection = () => {
  return (
    <section className='relative w-full min-h-screen bg-gradient-to-br from-[#050505] via-[#0a0a0a] via-[#0f0f0f] to-[#050505] py-8 md:py-16 px-4 md:px-6 flex justify-center'>
