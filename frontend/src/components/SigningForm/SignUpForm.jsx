...
import { googleAuth, registration } from '../../services/authService';
...
const SignUpForm = ({ handleSignUp }) => {
  ...
  const signUp = async data => {
    try {
      ...
      if (!responseData) {
        alert('Помилка: не вдалося отримати дані від сервера');
        return;
      }
    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className='flex flex-col items-center justify-center mb-6'>
          <Logo />
          <h2 className='text-xl md:text-2xl font-bold text-white tracking-tight mt-3'>Створити обліковий запис</h2>
        </div>
